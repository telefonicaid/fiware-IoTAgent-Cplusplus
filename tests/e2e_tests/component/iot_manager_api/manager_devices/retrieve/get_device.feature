Feature: Manager API Device Get Data
		...
		Examples:
			...
			|srv_devm_get	|/path_srv_devm_get	 |devm_get	|room_get	|thing_get	|http://myurl:10	|IoTUL2		|attr	|t			|int	|temp	|IoTUL2		|1		|	
			|srv_devm_get	|void				 |devm_get	|room_get	|thing_get	|http://myurl:10	|IoTTT		|attr	|t			|int	|temp	|			|1		|	
			|srv_devm_get	|/path_srv_devm_get1 |devm_get1	|room_get1	|thing_get1	|http://myurl:11	|IoTMqtt	|st_att	|t			|int	|11		|IoTMqtt	|1		|	
		...
		Examples:
			...
			|srv_devm_get	|/path_srv_devm_get	 |devm_get3	|			|200			|									|
