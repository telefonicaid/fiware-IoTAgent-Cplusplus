...
from common.steps import service_with_path_created_precond, device_not_created_precond, create_device_manager, create_device_with_attrs_cmds_manager, device_created
...
def create_device_failed(step, dev_name, service_path, protocol, typ, name, type1, value):
    ...
    if typ=='ent_name':
        ...
        world.req=functions.create_device(world.service_name, world.srv_path, dev_name, {}, world.commands, name, {}, world.attributes, world.st_attributes, protocol, True)
    elif typ=='protocol':
        if not name=='null':
            world.req=functions.create_device(world.service_name, world.srv_path, dev_name, {}, world.commands, {}, {}, world.attributes, world.st_attributes, name, True)
        else:
            world.req=functions.create_device(world.service_name, world.srv_path, dev_name, {}, world.commands, {}, {}, world.attributes, world.st_attributes, {}, True)
    else:        
        world.req=functions.create_device(world.service_name, world.srv_path, dev_name, {}, world.commands, {}, {}, world.attributes, world.st_attributes, protocol, True)
