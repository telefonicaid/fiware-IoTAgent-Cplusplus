Feature: MQTT Command Send 
	...
	Scenario: Send a command with parameters
		...
		Examples:
			...
			|dev1_1		|room1_1	 |servicemqtt	|IoTMqtt	|ping1_1	|p1=v1#p2=v2			|			|pull	  |void				|OK		|dev1_1@ping1_1#p1=v1#p2=v2				|
			|dev1_2		|room1_2	 |servicemqtt	|IoTMqtt	|ping1_2	|p1=v1#p2=v2#p3=v3#p4=v4|			|pull	  |void				|OK		|dev1_2@ping1_2#p1=v1#p2=v2#p3=v3#p4=v4	|
...
#			|dev2_1		|room2_1	 |servicemqtt	|IoTMqtt	|attr_1_dev_2_1	|ping2_1	|dev2_1@%s	|push	  |http://myurl.com	|dev2_1@ping2_1Result#Command_OK	|OK			|	
	...
	Scenario: Send a command without response
		...
		Examples:
			...
			|dev3		|room3		 |servicemqtt	|IoTMqtt	|ping3		|			|dev3@%s	|pull	  		|void				|expired read					|10		 |
			|dev3_1		|room3_1	 |servicemqtt	|IoTMqtt	|ping3_1	|			|dev3_1@%s	|push	 	 	|http://myurl.com	|delivered but no respond		|10		 |
			|dev3_2		|room3_2	 |servicemqtt	|IoTMqtt	|ping3_2	|			|dev3_2@%s	|pull_not_resp	|void				|delivered but no respond		|10		 |
			|dev3_3		|room3_3	 |servicemqtt	|IoTMqtt	|ping3_3	|			|dev3_3@%s	|push_not_resp 	|http://myurl.com	|delivered but no respond		|10		 |
#			|dev3		|room3		 |servicemqtt	|IoTMqtt	|attr_1_dev_3	|ping3		|dev3@%s	|pull	  		|void				|expired read					|10		 |
#			|dev3_1		|room3_1	 |servicemqtt	|IoTMqtt	|attr_1_dev_3_1	|ping3_1	|dev3_1@%s	|push	 	 	|http://myurl.com	|delivered but no respond		|10		 |
#			|dev3_2		|room3_2	 |servicemqtt	|IoTMqtt	|attr_1_dev_3_2	|ping3_2	|dev3_2@%s	|pull_not_resp	|void				|delivered but no respond		|10		 |
