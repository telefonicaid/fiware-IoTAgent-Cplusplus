...
@step('I list the devices of "([^"]*)", path "([^"]*)", entity "([^"]*)", detailed "([^"]*)", limit "([^"]*)" and offset "([^"]*)"')
def get_device_data(step, service_name, service_path, entity, detailed, limit, offset):
    headers = {}
    params = {}
    ...
    world.req =  api.get_listDevices(headers, params)
