Feature: Create Device
		...
		Examples:
			...
			|srv_dev_post1	|/path_srv_dev_post		|dev_post2		|			|thing_post		|					|
		...
		Examples:
			...
			|srv_dev_post2	|/path_srv_dev_post2	|dev_post5		|cmd	|cmd_dev5	|		|ping5	|cmd	|cmd2_dev5	|		|			|
		...
		Examples:
			...
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|cmd		|cmd_dev	|void		|ping	|400		|No enum match for: "" [/devices[0]/commands[0]/type]								|
			...
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|cmd		|cmd_dev	|comand		|ping	|400		|No enum match for: "comand" [/devices[0]/commands[0]/type]							|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post4	|dev_post		|			|			|			|		|404		|The service does not exist															|
			|srv_dev_post2	|/path_srv_dev_post2	|/path_srv_dev_post2	|dev_post		|			|			|			|		|409		|duplicate key: iot.DEVICE															|
			|srv_dev_post	|void					|void					|dev_post		|			|			|			|		|409		|duplicate key: iot.DEVICE															|
			|srv_dev_post	|/path_srv_dev_post		|/path_srv_dev_post		|dev_post2		|ent_name	|room_post1	|			|		|409		|entity already exists															|
