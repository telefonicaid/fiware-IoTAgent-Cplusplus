Feature: API Device Create
		...
		Examples:
			...
			|srv_dev_post2	|/path_srv_dev_post2	|dev_post		|IoTUL2		|attr	|t			|int	|temp	|		|			|		|			|
			|srv_dev_post2	|/path_srv_dev_post2_1	|dev_post1		|IoTTT		|attr	|t1			|int	|temp1	|attr	|h			|int	|hum		|
			|srv_dev_post2	|/path_srv_dev_post2_2	|dev_post2		|IoTMqtt	|st_att	|t2			|int	|22		|		|			|		|			|
			|srv_dev_post2	|/path_srv_dev_post2	|dev_post3		|IoTUL2		|st_att	|t3			|int	|33		|st_att	|h3			|int	|333		|
			...
			|srv_dev_post2	|/path_srv_dev_post2	|dev_post6		|IoTUL2		|attr	|t6			|int	|temp6	|st_att	|h6			|int	|666		|
			|srv_dev_post2	|/path_srv_dev_post2	|dev_post7		|IoTUL2		|attr	|t7			|int	|temp7	|cmd	|cmd_dev7	|		|ping7		|
			|srv_dev_post2	|/path_srv_dev_post2	|dev_post8		|IoTUL2		|st_att	|t8			|int	|88		|cmd	|cmd_dev8	|		|ping8		|
		...
		Examples:
			...
			|void			|void					|void					|dev_post		|IoTUL2		|attr		|t			|int		|temp	|400		|Fiware-Service not accepted														|
			|srv_dev_post3	|/path_srv_dev_post3	|path_srv_dev_post3		|dev_post		|IoTUL2		|attr		|t			|int		|temp	|400		|Fiware-ServicePath not accepted													|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|void			|IoTUL2		|attr		|t			|int		|temp	|400		|String is too short (0 chars), minimum 1 [/devices[0]/device_id]					|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|				|IoTUL2		|attr		|t			|int		|temp	|400		|Missing required property: device_id												|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|attr		|			|int		|temp	|400		|Missing required property: name [/devices[0]/attributes[0]]						|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|attr		|void		|int		|temp	|400		|String is too short (0 chars), minimum 1 [/devices[0]/attributes[0]/name]			|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|attr		|t			|			|temp	|400		|Missing required property: type [/devices[0]/attributes[0]]						|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|attr		|t			|void		|temp	|400		|String is too short (0 chars), minimum 1 [/devices[0]/attributes[0]/type]			|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|attr		|t			|int		|		|400		|Missing required property: object_id [/devices[0]/attributes[0]]					|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|attr		|t			|int		|void	|400		|String is too short (0 chars), minimum 1 [/devices[0]/attributes[0]/object_id]		|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|st_att		|			|int		|11		|400		|Missing required property: name [/devices[0]/static_attributes[0]]					|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|st_att		|void		|int		|11		|400		|String is too short (0 chars), minimum 1 [/devices[0]/static_attributes[0]/name]	|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|st_att		|t			|			|11		|400		|Missing required property: type [/devices[0]/static_attributes[0]]					|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|st_att		|t			|void		|11		|400		|String is too short (0 chars), minimum 1 [/devices[0]/static_attributes[0]/type]	|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|st_att		|t			|int		|		|400		|Missing required property: value [/devices[0]/static_attributes[0]]				|
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|st_att		|t			|int		|void	|400		|String is too short (0 chars), minimum 1 [/devices[0]/static_attributes[0]/value]	|
			...
			|srv_dev_post3	|/path_srv_dev_post3	|/path_srv_dev_post3	|dev_post		|IoTUL2		|cmd		|cmd_dev	|			|ping	|400		|Missing required property: type [/devices[0]/commands[0]]							|
