...
void Ul20Test::testCommandHandle()
{
    ...
    boost::shared_ptr<iota::Device> dev(new iota::Device("item_dev_name",get_service_name(__FUNCTION__)));
...
void Ul20Test::testPollingCommand_MONGO_CON()
{
    ...
    testPollingCommand_MONGO("unitTest_dev32_polling",
                             "type2:unitTest_dev32_polling", "type2", POST_DEVICE_CON2, service);
    ...
    std::string service)
{
    ...
    std::cout << "@UT@POST Device" << std::endl;
    std::string response;
    int code_res = ((iota::AdminService*)iota::Process::get_process().get_service("/TestUL"))->post_device_json( service, service_path, post_device,
               http_response, response);
    std::cout << "@UT@RESPONSE: " <<  code_res << " " << response << std::endl;
    IOTASSERT(code_res == POST_RESPONSE_CODE);
    ...
    bodySTR.append("]} ]}");
    {
        ...
        std::string cb_last = cb_mock->get_last("/mock/" + service + "/NGSI10/updateContext");
        std::cout << "@UT@READY_FOR_READ" <<cb_last << std::endl;
        // ready_for_read
    ...
    bodySTR = "";
    {
        ...
        query_parameters.insert(std::pair<std::string,std::string>("k","testPollingCommand"));
        pion::http::response http_response;
        std::string response;
        ul20serv->service(http_request, url_args, query_parameters,
                          http_response, response);
    ...
    code_res = ((iota::AdminService*)iota::Process::get_process().get_service("/TestUL"))->delete_service_json(  col, service, service_path, service, "testPollingCommand", "/TestUL/d", true,
