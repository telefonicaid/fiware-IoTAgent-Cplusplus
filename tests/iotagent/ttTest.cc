...
void TTTest::testSearchResponses() {
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testSearchResponses starting ... ");
  ...
  if (idsensor > 0) {
    ...
    std::string input =
      "cadena=#8934075379000039321,#0,GM,amp,3,#0,GC,refresh,33,#1,GM,inexistent,55,23$none";

    ibuffer.context.addInputData(input.c_str(),input.length());

    ESP_Result myResult = esplib.executeRunnerFromInput(idsensor,"main",params,
                          &ibuffer);
    ...
    std::string device_id = myResult.findInputAttributeAsString("request",
                            true); //The keyword "request" is defined somewhere in the ESP Xml file, how could I get it?
...
void TTTest::testTTResponses() {
  ...
  std::string
  param2("11");//This is the received value, it may not be the same as the stored one (from CB), but that's fine

  std::string
  expected("#0,GM,amp,$");//We expect the returned value from ContextBroker, not the one coming from ESP
  ...
  iota::esp::tt::TTResponse* ttResponse = iota::esp::tt::TTResponse::decodeStringToTTResponse(
                                      module);
...
void TTTest::testTTResponsesP1() {
  ...
  ttResponse->setBusId(busid);
  //TEST: INPUT from CB and INPUT from ESP (what comes from device) are compared
  ttResponse->processContextElement(cElement,mapAttr);
...
void TTTest::testTTResponsesP1NoTResponse() {
  ...
  std::string
  expected("#0,P1,$");//We expect the returned values from ContextBroker, not the one coming from ESP
  ...
  CC_Logger::getSingleton()->logDebug("testTTResponsesP1NoTResponse: output: %s",
                                      ttResponse->toTTString().c_str());
  CPPUNIT_ASSERT_EQUAL(expected,ttResponse->toTTString());
  CC_Logger::getSingleton()->logDebug("testTTResponsesP1NoTResponse: output: DONE");
  delete ttResponse;
...
void TTTest::testTTResponsesB() {
  ...
  CC_Logger::getSingleton()->logDebug("testTTResponsesB: Attribte compound: length %d",
                                      compound.get_value_compound().size());
  CC_Logger::getSingleton()->logDebug("testTTResponsesB: ContextElement attributes:  %d",
...
/*
  ...
  pt_cb.put("timeout", "1");
  pt_cb.put("service", "Fiware");
  pt_cb.put("service_path", "/srvpath6");
...
*/
  ...
  expected.append(":[{\"name\":\"TimeInstant\",\"type\":\"ISO8601\",\"value\":\"");
...
/*
Simple test to prove if decoding both Postprocessor outputs is working as expected
*/
void TTTest::testDecodeTTJSONS() {
  CC_Logger::getSingleton()->logDebug("testDecodeTTJSONS: starting");
  std::string
  processed("{\"name\":\"__TTCurrent_te\",\"type\":\"string\",\"value\":\"234\",\"metadatas\"");
  processed.append(":[{\"name\":\"TimeInstant\",\"type\":\"ISO8601\",\"value\":\"");
  processed.append("time");
  processed.append("\"}]}");

  std::string
  plain("{\"name\":\"te\",\"type\":\"string\",\"value\":\"234\",\"metadatas\"");
...
/*This test shows the scenario where it's the very first time a TT device communicates with this iotagent. The first thing is going to happen is that
...
/*
  ...
  */
  ...
  mockResponse.append("\"value\":\"88\""); //ATTENTION TO THIS: this has to come in the response.
  mockResponse.append("},{");
  ...
  std::string response;
  ttService->service(http_request, url_args, query_parameters,
  ...
  expected_p1.append("{\"name\":\"mnc\",\"type\":\"string\",\"value\":\"07\"},");
  expected_p1.append("{\"name\":\"cell-id\",\"type\":\"string\",\"value\":\"33f\"},");
  expected_p1.append("{\"name\":\"lac\",\"type\":\"string\",\"value\":\"633c\"}");

  std::string expected_b;
  expected_b.append("{\"name\":\"B\",\"type\":\"compound\",\"value\":");
  expected_b.append("[{\"name\":\"voltaje\",\"type\":\"string\",\"value\":\"11\"},");
  expected_b.append("{\"name\":\"estado_activacion\",\"type\":\"string\",\"value\":\"22\"},");
  expected_b.append("{\"name\":\"hay_cargador\",\"type\":\"string\",\"value\":\"33\"},");
  expected_b.append("{\"name\":\"estado_carga\",\"type\":\"string\",\"value\":\"44\"},");
  expected_b.append("{\"name\":\"modo_carga\",\"type\":\"string\",\"value\":\"55\"},");
  expected_b.append("{\"name\":\"tiempo_desco_stack\",\"type\":\"string\",\"value\":\"66\"}");
...
/*
Check with ThinkingThings Team, but I think K1 attribute does not get published as it has no value.
*/
...
/*
  ...
  */
  ...
  pion::http::request_ptr http_request(new pion::http::request("/TestSample/tt"));
  http_request->set_method("POST");
  http_request->set_content(query);
  std::map<std::string, std::string> url_args;
  std::multimap<std::string, std::string> query_parameters;
  ...
  CC_Logger::getSingleton()->logDebug("testFirstTimeTTAttributesWithK: CODE:  %d ",
                                      http_response.get_status_code());
  CC_Logger::getSingleton()->logDebug("testFirstTimeTTAttributesWithK: Response:  %s ",
                                      response.c_str());
...
void TTTest::testParsingResponseOnBug_IDAS20197() {
  ...
  CC_Logger::getSingleton()->logDebug("testParsingResponseOnBug_IDAS20197: Starting...");
  ...
  if (idSensor > 0) {
    ...
    ESP_Result myResult = libEsp.executeRunnerFromInput(idSensor,"main",params,
                          &ibuffer);



    CC_Logger::getSingleton()->logDebug("testParsingResponseOnBug_IDAS20197 Result size: %d",
                                        myResult.ppresults.size());


    std::string device_id = myResult.findInputAttributeAsString("request",true);
    ...
    CC_Logger::getSingleton()->logDebug("Test testParsingResponseOnBug_IDAS20197 Before parsing JSON [%s]",
                                        temp.c_str());
    decodeTT->parse(temp);
    CC_Logger::getSingleton()->logDebug("Test testParsingResponseOnBug_IDAS20197 decode JSON: [%s]",
...
void TTTest::testSearchResponsesGPS() {
   ...
   unsigned int port = iota::Process::get_process().get_http_port();
  MockService* cb_mock = (MockService*)iota::Process::get_process().get_service("/mock/update");
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testSearchResponsesGPS starting ... ");
  ...
  mockResponse.append("\"name\":\"location\",\"type\":\"string\",\"value\":\"WGS84\"}]");
  mockResponse.append("}],");
  mockResponse.append("\"id\":\"8934075379000039321\",");
  mockResponse.append("\"isPattern\":\"false\",\"type\":\"thing\"},");
  mockResponse.append("\"statusCode\":{\"code\":\"200\",\"reasonPhrase\":\"OK\"}}]}");

  cb_mock->set_response("/mock/update", 200,mockResponse);
...
void TTTest::testSearchResponseOnBug_IDAS20201() {
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testSearchResponseOnBug_IDAS20201 starting ... ");
  ...
  mockResponse.append("\"value\":\"3\",");
  mockResponse.append("\"metadatas\":[{");
  mockResponse.append("\"name\":\"sleeptime\",\"type\":\"string\",\"value\":\"234\"}]");
  mockResponse.append("}],");
  mockResponse.append("\"id\":\"8934075379000039321\",");
  mockResponse.append("\"isPattern\":\"false\",\"type\":\"thing\"},");
  mockResponse.append("\"statusCode\":{\"code\":\"200\",\"reasonPhrase\":\"OK\"}}]}");

  cb_mock->set_response("/mock/upd", 200,mockResponse);
  ...
  if (idsensor > 0) {
    ...
    std::string input =
      "cadena=#8934075379000039321,#0,GC,test,1,$,#0,B,12,23,34,45,56,67,50$wakeUP,#0,P1,1,2,3,4,5,$";
    ibuffer.context.addInputData(input.c_str(),input.length());
    ...
    CPPUNIT_ASSERT_EQUAL(
      std::string("#0,GC,test,1,$,#0,B,23,56,67,50$wakeUP,#0,P1,$"),response);

    CC_Logger::getSingleton()->logDebug("TEST: testSearchResponseOnBug_IDAS20201 DONE");
    delete queryC;
  }
  esplib.stopSensor(idsensor);
  esplib.destroySensor(idsensor);
...
void TTTest::testTTCBPublisherP1BOnBug_IDAS20202() {
  ...
  CC_Logger::getSingleton()->logDebug("testTTCBPublisherP1BOnBug_IDAS20202: starting");
  ...
  expected.append("[{\"name\":\"voltaje\",\"type\":\"string\",\"value\":\"12\"},");
  expected.append("{\"name\":\"estado_activacion\",\"type\":\"string\",\"value\":\"23\"},");
  expected.append("{\"name\":\"hay_cargador\",\"type\":\"string\",\"value\":\"34\"},");
  expected.append("{\"name\":\"estado_carga\",\"type\":\"string\",\"value\":\"45\"},");
  expected.append("{\"name\":\"modo_carga\",\"type\":\"string\",\"value\":\"56\"},");
  expected.append("{\"name\":\"tiempo_desco_stack\",\"type\":\"string\",\"value\":\"67\"}],");
  expected.append("\"metadatas\":[{\"name\":\"sleepcondition\",\"type\":\"string\",\"value\":\"wakeUP\"},");
  expected.append("{\"name\":\"sleeptime\",\"type\":\"string\",\"value\":\"50\"},");
  expected.append("{\"name\":\"TimeInstant\",\"type\":\"ISO8601\",\"value\":\"");
  expected.append(strTime);
  expected.append("\"}]},");
  expected.append("{\"name\":\"TimeInstant\",\"type\":\"ISO8601\",\"value\":\"");
  ...
  jsonTT.append("[{\"name\":\"voltaje\",\"type\":\"string\",\"value\":\"12\"},");
  jsonTT.append("{\"name\":\"estado_activacion\",\"type\":\"string\",\"value\":\"23\"},");
  jsonTT.append("{\"name\":\"hay_cargador\",\"type\":\"string\",\"value\":\"34\"},");
  jsonTT.append("{\"name\":\"estado_carga\",\"type\":\"string\",\"value\":\"45\"},");
  jsonTT.append("{\"name\":\"modo_carga\",\"type\":\"string\",\"value\":\"56\"},");
  jsonTT.append("{\"name\":\"tiempo_desco_stack\",\"type\":\"string\",\"value\":\"67\"}],");
  jsonTT.append("\"metadatas\":[{\"name\":\"sleepcondition\",\"type\":\"string\",\"value\":\"wakeUP\"},");
  jsonTT.append("{\"name\":\"sleeptime\",\"type\":\"string\",\"value\":\"50\"}]}");
  ...
  CPPUNIT_ASSERT_EQUAL(expected,actual);
  CC_Logger::getSingleton()->logDebug("testTTCBPublisherP1BOnBug_IDAS20202: DONE");
  delete ttPublisher;
...
void TTTest::testTTCBPublisherGMOnBug_IDAS20202() {
  ...
  CC_Logger::getSingleton()->logDebug("testTTCBPublisherGMOnBug_IDAS20202: starting");
  ...
  CPPUNIT_ASSERT_EQUAL(expected,actual);
  CC_Logger::getSingleton()->logDebug("testTTCBPublisherGMOnBug_IDAS20202: DONE");
  delete ttPublisher;
...
void TTTest::testMissingSubAttributesBug_single_P1_Module_IDAS20245(){
  ...
  //cb_mock_up.reset(new HttpMock("/NGSI10/updateContext"));
   unsigned int port = iota::Process::get_process().get_http_port();
  MockService* cb_mock = (MockService*)iota::Process::get_process().get_service("/mock/query");
  ...
  CC_Logger::getSingleton()->logDebug("testMissingSubAttributesBug_single_P1_Module_IDAS20245: starting");
  //esp::TTService ttService;
  iota::esp::TTService* ttService = (iota::esp::TTService*)iota::Process::get_process().get_service("/TestTT/tt");

  std::string query =
    "cadena=#8934075379000039321,#0,P1,214,07,,633c";
  ...
  CC_Logger::getSingleton()->logDebug("testMissingSubAttributesBug_single_P1_Module_IDAS20245: CODE:  %d ",
                                      http_response.get_status_code());
  CC_Logger::getSingleton()->logDebug("testMissingSubAttributesBug_single_P1_Module_IDAS20245: Response:  %s ",
                                      response.c_str());
  CPPUNIT_ASSERT (http_response.get_status_code() == 200);
...
CC_Logger::getSingleton()->logDebug("testMissingSubAttributesBug_multiple_P1_GPS_B_Module_IDAS20245: starting");
  ...
  CC_Logger::getSingleton()->logDebug("testMissingSubAttributesBug_multiple_P1_GPS_B_Module_IDAS20245: CODE:  %d ",
                                      http_response.get_status_code());
  CC_Logger::getSingleton()->logDebug("testMissingSubAttributesBug_multiple_P1_GPS_B_Module_IDAS20245: Response:  %s ",
                                      response.c_str());

  CPPUNIT_ASSERT_EQUAL(
    std::string("#0,GM,temp,$,#0,K1,0$"),
    response);
  CPPUNIT_ASSERT(http_response.get_status_code() == 200);
}
...
void TTTest::testNoEmptyResponsesOnBug_IDAS20303() {
  ...
  for (std::vector<std::string>::const_iterator it = v_query.begin() ;
    ...
    query.assign(*it);
    CC_Logger::getSingleton()->logDebug("testNoEmptyResponsesOnBug_IDAS20303: query:  %s ",
                                        query.c_str());
    ...
    CC_Logger::getSingleton()->logDebug("testNoEmptyResponsesOnBug_IDAS20303: CODE:  %d ",
                                        http_response.get_status_code());
    CC_Logger::getSingleton()->logDebug("testNoEmptyResponsesOnBug_IDAS20303: Response:  %s ",
                                        response.c_str());
...
void TTTest::testErrorCodesOnBug_IDAS20303() {
  ...
  std::string
  query_404("cadena=#89340753321,#0,GM,temp,23,$,#0,P1,23,23,44,55,$");
  ...
  CC_Logger::getSingleton()->logDebug("testErrorCodesOnBug_IDAS20303: query:  %s ",
                                      query_404.c_str());
  ...
  CC_Logger::getSingleton()->logDebug("testErrorCodesOnBug_IDAS20303: CODE:  %d ",
                                      http_response.get_status_code());
  CC_Logger::getSingleton()->logDebug("testErrorCodesOnBug_IDAS20303: Response:  %s ",
                                      response.c_str());
...
/**
Bug was about getting 500 error when dealing with one incorrect GM but having others correct, like another GM, or P1
*/
void TTTest::testErrorCodesOnBug_IDAS20308(){
CC_Logger::getSingleton()->logDebug("testErrorCodesOnBug_IDAS20308: starting");
  ...
  std::string query =
    "cadena=#8934075379000039321,#0,GM,,23,$,#0,GM,test,22,$,#0,P1,214,33,33f,633c,#0,K1,0$";
  ...
  CC_Logger::getSingleton()->logDebug("testErrorCodesOnBug_IDAS20308: CODE:  %d ",
                                      http_response.get_status_code());
  CC_Logger::getSingleton()->logDebug("testErrorCodesOnBug_IDAS20308: Response:  %s ",
                                      response.c_str());

  CPPUNIT_ASSERT_EQUAL(
    std::string("#0,GM,test,$,#0,P1,$,#0,K1,0$"),
    response);
  CPPUNIT_ASSERT(http_response.get_status_code() == 200);
}
...
void TTTest::testNoEmpty_And_ValidResponse_OnBug_IDAS20308(){
  ...
  cb_mock->set_response("/mopck/query", 200,mockResponse); //Second query.

  cb_mock->set_response("/mopck/query",404,mockResponseError);
  cb_mock->set_response("/mopck/query",200,mockResponse);
  ...
  v_query.push_back("cadena=#8934075379000039321,#0,GM,test,,$,#0,GM,temp,55,$");
...
void TTTest::testError_when_empty_response_from_CB(){
 unsigned int port = iota::Process::get_process().get_http_port();
  ...
  std::multimap<std::string, std::string> query_parameters;
    ...
    CC_Logger::getSingleton()->logDebug("testError_when_empty_response_from_CB: query:  %s ",
                                        query.c_str());
    ...
    CC_Logger::getSingleton()->logDebug("testError_when_empty_response_from_CB: CODE:  %d ",
                                        http_response.get_status_code());
    CC_Logger::getSingleton()->logDebug("testError_when_empty_response_from_CB: Response:  %s ",
                                        response.c_str());
