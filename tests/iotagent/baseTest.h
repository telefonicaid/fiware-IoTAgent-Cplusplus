...
class BaseTest  {
  ...
  protected:
    ...
    void feature(const std::string& name,
   ...
   /**
     ...
     * @param [in] service, complete service field for config.json, empty by default
     *
     * Example Usage:
     * @code
     ...
     * @endcode
     */
    int delete_mongo( const std::string& table,
                 const std::string& service,
                 const std::string& service_path);
   ...
   /**
     ...
     * Example Usage:
     * @code
     *    check_mongo("SERVICE", "{\"service\": \"srv1\", \"service_path\": \"/srv_path\"");
     * @endcode
     */
    int check_mongo(const std::string& table,
