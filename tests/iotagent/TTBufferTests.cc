...
void TTBufferTests::testParsingTTOpenBuffer() {
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testParsingTTOpenBuffer starting ... ");

  int idsensor = esplib.createSensor("../../tests/iotagent/sensortt-open.xml");

  std::string expected1("{\"name\":\"t\",\"type\":\"string\",\"value\":\"34\"}");
  std::string
  expected2("{\"name\":\"posicion\",\"type\":\"string\",\"value\":\"33.000/-3.234234\"}");
  ...
  expected3.append(",{\"name\":\"cell-id\",\"type\":\"string\",\"value\":\"33f\"},");
  expected3.append("{\"name\":\"lac\",\"type\":\"string\",\"value\":\"633c\"}]}");
  ...
  if (idsensor > 0) {
    ...
    std::string input =
      "cadena=#8934075379000039321,#0,GM,t,34,#0,GM,posicion,33.000/-3.234234,#0,P1,214,07,33f,633c";

    ibuffer.context.addInputData(input.c_str(),input.length());

    std::vector<CC_AttributesType> result = esplib.executeRunnerFromInput(idsensor,
                                        "main",params,&ibuffer).attresults;
    ...
    std::string temp;
    //After resolution of bug IDAS-20245, postprocessor-tt is not included in ESP pipeline anymore
    int i=0;
    for (int j=1;j< result.size(); j++){
        //Note that the first position is the "request" field, so it has to be ignored in this instance
...
void TTBufferTests::testPostProcessorTTGM() {
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGM Initializating postprocessor");
  ...
  //delete decodeObject;
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGM postprocessor executed");

}

void TTBufferTests::testPostProcessorTTGCwithSleepCondAndSleepTime() {
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGCwithSleepCondAndSleepTime STARTING");
  ...
  esp_sleepcond.setValue("sleepcondition",sleepcond.c_str(),sleepcond.length(),
                         ESP_DataType::ESP_DataType_STRING,ESP_DataCode::ESP_DataCode_STRING);
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGCwithSleepCondAndSleepTime Initializating postprocessor");
  postProcessorTT->initialize();
  ...
  CPPUNIT_ASSERT_EQUAL(expected,decodeTT->getProcessedJSON());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGCwithSleepCondAndSleepTime postprocessor executed");

}


void TTBufferTests::testPostProcessorTTGCwithSleepCond() {
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGCwithSleepCond  STARTING");
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGCwithSleepCond Initializating postprocessor");
  postProcessorTT->initialize();

  CPPUNIT_ASSERT(postProcessorTT->execute(&mapAttr));
  CC_Logger::getSingleton()->logDebug("EXPECTED %s",expected.c_str());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGCwithSleepCond postprocessor executed");
  CPPUNIT_ASSERT(postProcessorTT->isResultValid());
  std::string actual(postProcessorTT->getResultData());
  decodeTT->parse(actual);
  CPPUNIT_ASSERT_EQUAL(expected,decodeTT->getProcessedJSON());
...
void TTBufferTests::testPostProcessorTTGCwithSleepTime() {
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGCwithSleepTime  STARTING");
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGCwithSleepTime Initializating postprocessor");
  postProcessorTT->initialize();

  CPPUNIT_ASSERT(postProcessorTT->execute(&mapAttr));
  CC_Logger::getSingleton()->logDebug("EXPECTED %s",expected.c_str());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGCwithSleepTime postprocessor executed");
  CPPUNIT_ASSERT(postProcessorTT->isResultValid());
  std::string actual(postProcessorTT->getResultData());
  decodeTT->parse(actual);
  CPPUNIT_ASSERT_EQUAL(expected,decodeTT->getProcessedJSON());
...
void TTBufferTests::testPostProcessorTTGMwithSleepCondAndSleepTime() {
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGMwithSleepCondAndSleepTime  STARTING");
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGMwithSleepCondAndSleepTime Initializating postprocessor");
  postProcessorTT->initialize();

  CPPUNIT_ASSERT(postProcessorTT->execute(&mapAttr));
  CC_Logger::getSingleton()->logDebug("EXPECTED %s",expected.c_str());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGMwithSleepCondAndSleepTime postprocessor executed");
  CPPUNIT_ASSERT(postProcessorTT->isResultValid());
  std::string actual(postProcessorTT->getResultData());
...
void TTBufferTests::testPostProcessorTTP1() {
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTP1 Initializating postprocessor");
  postProcessorTT->initialize();
  ...
  CC_Logger::getSingleton()->logDebug("ACTUAL %s",
                                      decodeTT->getProcessedJSON().c_str());
  CPPUNIT_ASSERT_EQUAL(expected,decodeTT->getProcessedJSON());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTP1 postprocessor executed");
...
void TTBufferTests::testPostProcessorTTGPS() {
  ...
  */
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGPS Initializating postprocessor");
  postProcessorTT->initialize();
  ...
  decodeTT->parse(actual);
  CPPUNIT_ASSERT_EQUAL(expected,decodeTT->getProcessedJSON());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGPS postprocessor executed");
...
void TTBufferTests::testPostProcessorTTGPSNoSleepCondOrTime() {
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGPSNoSleepCondOrTime  STARTING");
  ...
  */
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGPSNoSleepCondOrTime Initializating postprocessor");
  postProcessorTT->initialize();
  ...
  decodeTT->parse(actual);
  CPPUNIT_ASSERT_EQUAL(expected,decodeTT->getProcessedJSON());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGPSNoSleepCondOrTime postprocessor executed");
...
void TTBufferTests::testPostProcessorTTGPSSleepCondOrTimeEmpty() {
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGPSSleepCondOrTimeEmpty  STARTING");
  ...
  */
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGPSSleepCondOrTimeEmpty Initializating postprocessor");
  postProcessorTT->initialize();
  ...
  decodeTT->parse(actual);
  CPPUNIT_ASSERT_EQUAL(expected,decodeTT->getProcessedJSON());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTGPSSleepCondOrTimeEmpty postprocessor executed");
...
/**
  @brief The bug appears when a measure with either sleepcond or sleeptime is processed and next another without them
  comes in, the previous value is stored and returned on the recent measure, which is wrong.
*/
void TTBufferTests::testPostProcessorWrongSleepCondTimeOnBug_IDAS20215(){



  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorWrongSleepCondTimeOnBug_IDAS20215 Starting...");
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorWrongSleepCondTimeOnBug_IDAS20215 Initializating postprocessor");
  postProcessorTT->initialize();

  CPPUNIT_ASSERT(postProcessorTT->execute(&mapAttr));
  CC_Logger::getSingleton()->logDebug("EXPECTED %s",expected.c_str());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorWrongSleepCondTimeOnBug_IDAS20215 postprocessor executed FIRST TIME");
   CPPUNIT_ASSERT(postProcessorTT->isResultValid());
  std::string actual(postProcessorTT->getResultData());
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorWrongSleepCondTimeOnBug_IDAS20215 Initializating postprocessor SECOND TIME");
  expected.assign("{");
  expected.append("\"name\":\"");
  expected.append(param1);
  expected.append("\",");
  ...
  CPPUNIT_ASSERT(postProcessorTT->execute(&mapAttr));
  CC_Logger::getSingleton()->logDebug("EXPECTED %s",expected.c_str());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorWrongSleepCondTimeOnBug_IDAS20215 postprocessor executed SECOND TIME");
   CPPUNIT_ASSERT(postProcessorTT->isResultValid());
...
/**
  @brief Same bug (sleepcond and sleeptime) are retained from previous measure, but reverse direction, first measure without
  sleepcond and sleeptime and next with those values.
*/
void TTBufferTests::testPostProcessorReverseWrongSleepCondTimeOnBug_IDAS20215(){


  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorReverseWrongSleepCondTimeOnBug_IDAS20215 Starting...");
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorReverseWrongSleepCondTimeOnBug_IDAS20215 Initializating postprocessor");
  postProcessorTT->initialize();

  CPPUNIT_ASSERT(postProcessorTT->execute(&mapAttr));
  CC_Logger::getSingleton()->logDebug("EXPECTED %s",expected.c_str());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorReverseWrongSleepCondTimeOnBug_IDAS20215 postprocessor executed FIRST TIME");
   CPPUNIT_ASSERT(postProcessorTT->isResultValid());
  std::string actual(postProcessorTT->getResultData());
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorReverseWrongSleepCondTimeOnBug_IDAS20215 Initializating postprocessor SECOND TIME");
  expected.assign("{");
  expected.append("\"name\":\"");
  expected.append(param1);
  expected.append("\",");
  ...
  CPPUNIT_ASSERT(postProcessorTT->execute(&mapAttr));
  CC_Logger::getSingleton()->logDebug("EXPECTED %s",expected.c_str());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorReverseWrongSleepCondTimeOnBug_IDAS20215 postprocessor executed SECOND TIME");
   CPPUNIT_ASSERT(postProcessorTT->isResultValid());
  actual.assign(postProcessorTT->getResultData());
...
void TTBufferTests::testPostProcessorMissingAttributes(){
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorMissingAttributes Starting...");



  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorMissingAttributes checking P1...");
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorMissingAttributes Initializating postprocessor");
  postProcessorTT->initialize();

  CPPUNIT_ASSERT(postProcessorTT->execute(&mapAttr));


  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorMissingAttributes postprocessor executed FOR P1");
  CPPUNIT_ASSERT(!postProcessorTT->isResultValid());
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorMissingAttributes postprocessor executed FOR GPS");
  CPPUNIT_ASSERT(!postProcessorTT->isResultValid());
  postProcessorTT->terminate();
  mapAttr.clear();
  module.assign("B");
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorMissingAttributes postprocessor executed FOR B");
  CPPUNIT_ASSERT(!postProcessorTT->isResultValid());
  postProcessorTT->terminate();
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorMissingAttributes postprocessor executed FOR GM");
  CPPUNIT_ASSERT(!postProcessorTT->isResultValid());
  postProcessorTT->terminate();
}
...
void TTBufferTests::testPostProcessorTTB()
{
  ...
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTB Initializating postprocessor");
  std::string busid("0");
  std::string module("B");
  std::string param1("11");
  ...
  expected.append("\"name\":\"estado_activacion\",\"type\":\"string\",\"value\":\"");
  expected.append(param2);
  expected.append("\"},{");
  ...
  expected.append(param5);
  expected.append("\"},{");
  expected.append("\"name\":\"tiempo_desco_stack\",\"type\":\"string\",\"value\":\"");
  ...
  CC_Logger::getSingleton()->logDebug("ACTUAL %s",
                                      decodeTT->getProcessedJSON().c_str());
  CPPUNIT_ASSERT_EQUAL(expected,decodeTT->getProcessedJSON());
  CC_Logger::getSingleton()->logDebug("TEST: testPostProcessorTTB postprocessor executed");
}
