...
#define JSON_PARSER_UNSIGNED_SSCANF_TOKEN "%llu"
#define JSON_PARSER_UNSIGNED_SPRINTF_TOKEN "%llu"
#else 
typedef long JSON_int_t;
typedef unsigned long JSON_uint_t;
#define JSON_PARSER_INTEGER_SSCANF_TOKEN "%ld"
#define JSON_PARSER_INTEGER_SPRINTF_TOKEN "%ld"
#define JSON_PARSER_UNSIGNED_SSCANF_TOKEN "%lu"
#define JSON_PARSER_UNSIGNED_SPRINTF_TOKEN "%lu"
#endif
