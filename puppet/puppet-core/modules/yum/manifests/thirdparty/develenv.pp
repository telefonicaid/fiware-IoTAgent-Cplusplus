...
#  }
  ...
  yumrepo { "ss-develenv-noarch":
    baseurl  => 'http://artifactory.aislada.hi.inet/artifactory/yum-develenv/26/noarch',
    descr    => 'ss-develenv',
    enabled  => '1',
    gpgcheck => '0',
    notify   => Exec['clean_yum_cache'],
  ...
  yumrepo { "ss-develenv-x86_64":
    baseurl  => 'http://artifactory.aislada.hi.inet/artifactory/yum-develenv/26/x86_64',
    descr    => 'ss-develenv',
    enabled  => '1',
    gpgcheck => '0',
    notify   => Exec['clean_yum_cache'],
