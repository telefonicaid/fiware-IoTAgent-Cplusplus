I used the original module: "puppet module install rodjek/logrotate".

Adding a parameter: notifempty

and fast configuration: easy_rule.

It assumes that the logs are the directory: /var/log/

And you can rotate by day or size.
