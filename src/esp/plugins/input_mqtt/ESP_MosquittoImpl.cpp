...
ESP_MosquittoImpl::ESP_MosquittoImpl(const char* id,
                                     bool cleanSession):mosquittopp(id,cleanSession) {
...
int ESP_MosquittoImpl::mqttDisconnect() {
  return disconnect();
}

int ESP_MosquittoImpl::mqttReconnect() {
  return reconnect();
}
...
void ESP_MosquittoImpl::on_connect(int rc) {
  mqttCallBack->on_connect(rc);
}
...
void ESP_MosquittoImpl::on_publish(int mid) {
  mqttCallBack->on_publish(mid);
}
