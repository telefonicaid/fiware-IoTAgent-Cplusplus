...
class TiXmlBase {
  ...
  */
  ...
  /** Return the position, in the original source file, of this node or
     ...
     TiXmlDocument::Load(),
      TiXmlDocument::LoadFile(), or any TiXmlNode::Parse() is called. It will
     NOT be set
...
class TiXmlNode : public TiXmlBase {
  ...
  */
  ...
  const TiXmlNode* FirstChild() const {
    return firstChild;  ///< The first child of this node. Will be null if there
    /// are no children.
  }
  ...
  const TiXmlNode* LastChild() const {
    return lastChild;  /// The last child of this node. Will be null if there
                       /// are no children.
  }
  ...
  */
  ...
  virtual const TiXmlDocument* ToDocument() const {
    return 0;  ///< Cast to a more defined type. Will return null if not of the
    /// requested type.
  }
...
class TiXmlElement : public TiXmlNode {
  ...
  */
  ...
  virtual const TiXmlElement* ToElement() const {
    return this;  ///< Cast to a more defined type. Will return null not of the
    /// requested type.
  }
  virtual TiXmlElement* ToElement() {
    return this;  ///< Cast to a more defined type. Will return null not of the
...
class TiXmlDocument : public TiXmlNode {
  ...
  */
  ...
  /* Write the document to a string using formatted printing ("pretty print").
     This
      will allocate a character array (new char[]) and return it as a pointer.
     The
...
/**
   ...
   "Element" ).Child( "Child", i ).ToElement();
        if ( !child )
            break;
        // do something
        ++i;
