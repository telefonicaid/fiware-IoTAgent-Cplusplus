  ...
  public:
    ...
    */
    ...
    TiXmlDocument* GetDocument() {
      return const_cast< TiXmlDocument* >((const_cast< const TiXmlNode* >
                                           (this))->GetDocument());
    }
  ...
  public:
    ...
    */
    ...
    void SetIntValue(int
                     _value);                                      ///< Set the value from an integer.
    void SetDoubleValue(double
                        _value);                                ///< Set the value from a double.
...
class TiXmlElement : public TiXmlNode {
  public:
    ...
    */
    template< typename T > int QueryValueAttribute(const std::string& name,
        T* outValue) const {
...
class TiXmlUnknown : public TiXmlNode {
  public:
    ...
    TiXmlUnknown(const TiXmlUnknown& copy) : TiXmlNode(
