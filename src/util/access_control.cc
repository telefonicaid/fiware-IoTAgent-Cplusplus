...
void iota::AccessControl::set_timeout(int timeout) {
  _timeout = timeout;
}

int iota::AccessControl::get_timeout() {
  return _timeout;
}

std::string iota::AccessControl::get_endpoint_ac() {
  return _endpoint_ac;
}
...
pion::http::request_ptr iota::AccessControl::create_request(std::string server,
    std::string resource,
...
std::string iota::AccessControl::create_xml_access_control(
  ...
  root_node.put("<xmlattr>.xsi:schemaLocation",
                std::string("urn:oasis:names:tc:xacml:3.0:core:schema:wd-17 http://docs.oasis-open.org/xacml/3.0/xacml-core-v3-schema-wd-17.xsd"));
  root_node.put("<xmlattr>.ReturnPolicyIdList", std::string("false"));
  root_node.put("<xmlattr>.CombinedDecision", std::string("false"));
  attributes_resource_node.put("<xmlattr>.Category",
  ...
  attribute_resource_value.put("<xmlattr>.DataType",
  ...
  attribute_resource.put("<xmlattr>.AttributeId",
  ...
  attributes_action_node.put("<xmlattr>.Category",
  ...
  attributes_roles_node.put("<xmlattr>.Category",
                            std::string("urn:oasis:names:tc:xacml:1.0:subject-category:access-subject"));
  for (int i = 0; i < roles.size(); i++) {
    boost::property_tree::ptree attribute_role_value;
    boost::property_tree::ptree attribute_role;
    attribute_role_value.put("<xmlattr>.DataType",
                             std::string("http://www.w3.org/2001/XMLSchema#string"));
    attribute_role_value.put("", roles[i]);
    attribute_role.put("<xmlattr>.IncludeInResult", std::string("false"));
    attribute_role.put("<xmlattr>.AttributeId",
