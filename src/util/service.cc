...
void iota::Service::put(const std::string& resource_name, const std::string& value) {
   iota::JsonValue v;
...
void iota::Service::put(const std::string& resource_name, int value) {
  iota::JsonValue v;
  v.SetInt(value);
  iota::JsonValue key(resource_name, document.GetAllocator());
  _document.AddMember(key, v, _document.GetAllocator());
}

std::string iota::Service::get_resource() {
  return _resource;
};
...
std::string iota::Service::get_token() {
  return _token;
};

void iota::Service::set_token(const std::string& token) {
  _token = token;
}

std::string iota::Service::get_service_path() {
...
int iota::Service::get_timeout() {
  return _timeout;
};

void iota::Service::set_timeout(int timeout) {
  _timeout = timeout;
}

std::string iota::Service::get_service() {
  return _service;
};
...
std::string iota::Service::get_cbroker() {
  return _cbroker;
};
...
std::string iota::Service::get_real_name() const {
  return _service;
}
