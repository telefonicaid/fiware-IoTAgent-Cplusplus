...
class OAuth: public boost::enable_shared_from_this<OAuth> {
  ...
  public:
    ...
    */
    ...
    void set_project(std::string subservice) {
      _project = subservice;
    };
    ...
    boost::property_tree::ptree get_roles() {
      return _user_roles;
    };

    std::string get_subserviceId() {
      return _subservice_id;
    };

    std::string get_serviceId() {
      return _service_id;
    };
    ...
    void receive_event_renew_token(
  ...
  private:
    ...
    std::string send_request(std::string path, std::string method,
                             std::string content,
                             std::string query, boost::property_tree::ptree headers, std::string f,
