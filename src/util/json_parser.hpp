...
// ----------------------------------------------------------------------------
#ifndef IOTA_BOOST_PROPERTY_TREE_JSON_PARSER_HPP_INCLUDED
#define IOTA_BOOST_PROPERTY_TREE_JSON_PARSER_HPP_INCLUDED
...
namespace iota { namespace property_tree { namespace json_parser
{
                   ...
                   const std::locale &loc = std::locale())
    {
        ...
        if (!stream)
            BOOST_PROPERTY_TREE_THROW(boost::property_tree::json_parser::json_parser_error(
