...
class RiotISO8601 {
  public:
    ...
    RiotISO8601(std::string a, std::string m, std::string d,
    ...
    const boost::posix_time::ptime& getPosixTime(void) const {
      return _ptime;
    };
    const boost::posix_time::time_duration& getDiffUTC(void) const {
      return _dUTC;
    };
    const bool isLocal(void) const {
      return _local;
    };
    boost::posix_time::ptime& getPosixTime(void) {
      return _ptime;
    };
    boost::posix_time::time_duration& getDiffUTC(void) {
      return _dUTC;
    };
    bool isLocal(void) {
      return _local;
