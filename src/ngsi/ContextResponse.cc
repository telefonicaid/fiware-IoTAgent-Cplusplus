...
iota::ContextResponse::ContextResponse(const std::istringstream&
                                       str_context_response) {
  ...
  if (!document.HasMember(iota::ngsi::NGSI_STATUSCODE.c_str()) ||
      ...
      !document[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_CODE.c_str()].IsString()) {
    std::ostringstream what;
    what << "ContextResponse: ";
  ...
  _code.assign(
    document[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_CODE.c_str()].GetString());

  if (document[iota::ngsi::NGSI_STATUSCODE.c_str()].HasMember(
        iota::ngsi::NGSI_REASONPHRASE.c_str()) &&
      document[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_REASONPHRASE.c_str()].IsString())  {
    _reason.assign(
      document[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_REASONPHRASE.c_str()].GetString());
  }
  if (document[iota::ngsi::NGSI_STATUSCODE.c_str()].HasMember(
        iota::ngsi::NGSI_DETAILS.c_str()) &&
      document[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_DETAILS.c_str()].IsString())  {
    _details.assign(
      document[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_DETAILS.c_str()].GetString());
  }
...
iota::ContextResponse::ContextResponse(const rapidjson::Value&
                                       context_response) {
  ...
  if (!context_response.HasMember(iota::ngsi::NGSI_STATUSCODE.c_str()) ||
      ...
      !context_response[iota::ngsi::NGSI_STATUSCODE.c_str()].HasMember(
        iota::ngsi::NGSI_CODE.c_str()) ||
      !context_response[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_CODE.c_str()].IsString()) {
    std::ostringstream what;
    what << "ContextResponse: ";
    what << "invalid or missing field [" << iota::ngsi::NGSI_STATUSCODE << "]";
    throw std::runtime_error(what.str());
  ...
  _code.assign(
    context_response[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_CODE.c_str()].GetString());

  if (context_response[iota::ngsi::NGSI_STATUSCODE.c_str()].HasMember(
        iota::ngsi::NGSI_REASONPHRASE.c_str()) &&
      context_response[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_REASONPHRASE.c_str()].IsString())  {
    _reason.assign(
      context_response[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_REASONPHRASE.c_str()].GetString());
  }
  if (context_response[iota::ngsi::NGSI_STATUSCODE.c_str()].HasMember(
        iota::ngsi::NGSI_DETAILS.c_str()) &&
      context_response[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_DETAILS.c_str()].IsString())  {
    _details.assign(
      context_response[iota::ngsi::NGSI_STATUSCODE.c_str()][iota::ngsi::NGSI_DETAILS.c_str()].GetString());
  }
...
void iota::ContextResponse::add_context_element(const iota::ContextElement&
    context_element) {
